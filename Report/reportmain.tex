...
\end{align}
with $m$ the total number of edges and $n$ the total number of vertices. Adding as much edges as vertices is therefore a necessary condition to keep the average degree (and hence the degree distribution) constant during the process.
